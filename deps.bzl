...
def go_dependencies():
    ...
    go_repository(
        name = "com_github_rderik_bazel_learning_projects_go_libs_calculator",
        importpath = "github.com/rderik/bazel-learning/projects/go-libs/calculator",
        sum = "h1:LoLyG3rrvE2M3mm6OmDUKVWlCuMtUFPVjMP7s1aeO3Y=",
        version = "v0.0.0-20230322154948-653a72fa26b9",
    )
    go_repository(
